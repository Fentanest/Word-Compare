...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(644, 687)
        MainWindow.setMinimumSize(QSize(644, 687))
        MainWindow.setMaximumSize(QSize(644, 687))
        icon = QIcon()
...
"}")
        ...
        self.grpSavePath.setGeometry(QRect(20, 370, 440, 100))
        font = QFont()
        ...
        self.layoutWidget = QWidget(self.grpSavePath)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(10, 60, 420, 30))
        self.horizontalLayout = QHBoxLayout(self.layoutWidget)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.btnBrowsePath = QPushButton(self.layoutWidget)
        ...
        self.btnOpenPath = QPushButton(self.layoutWidget)
        ...
        self.txtLogOutput.setGeometry(QRect(20, 480, 600, 150))
        ...
        self.groupBoxfiles.setGeometry(QRect(20, 10, 600, 340))
        self.listViewafter = QListView(self.groupBoxfiles)
        self.listViewafter.setObjectName(u"listViewafter")
        self.listViewafter.setGeometry(QRect(310, 30, 280, 290))
        ...
        self.listViewbefore.setGeometry(QRect(10, 30, 280, 290))
        ...
        self.groupBox.setGeometry(QRect(470, 370, 150, 100))
        self.checkBoxExcel = QCheckBox(self.groupBox)
        self.checkBoxExcel.setObjectName(u"checkBoxExcel")
        self.checkBoxExcel.setGeometry(QRect(10, 70, 130, 23))
